        ...
        >
          <div className="flex flex-col items-center gap-5 py-2">
            ...
            <div
              ...
              style={{ background: 'var(--danger-muted)', border: '1px solid rgba(251,113,133,0.25)' }}
            >
            ...
            <div
              ...
              style={{ borderColor: 'rgba(251,113,133,0.25)', background: 'var(--danger-muted)' }}
            >
      ...
      <>
        ...
        >
          <div className="flex flex-col items-center gap-5 py-2 text-center">
            <div
              className="flex h-14 w-14 items-center justify-center rounded-2xl"
              style={{ background: 'var(--success-muted)', border: '1px solid rgba(16,217,138,0.2)' }}
            >
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5" noValidate>
          ...
          <div className="flex items-center gap-1.5">
            {Array.from({ length: 3 }).map((_, i) => (
              <div
                ...
                style={{ background: i < 3 ? 'var(--page-accent)' : 'var(--border)' }}
              />
            ))}
          ...
          {serverError && (
            <div
              role="alert"
              className="rounded-lg border border-[var(--danger)]/30 bg-[var(--danger-muted)] px-4 py-3 text-xs text-[var(--danger-fg)] flex items-start justify-between gap-3"
            >
