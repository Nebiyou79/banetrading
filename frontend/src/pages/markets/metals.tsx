...
const MetalsMarketsPage: NextPage = () => {
  const { rows, source, stale, isLoading, error, refetch } = useMetals();
...
export default MetalsMarketsPage;