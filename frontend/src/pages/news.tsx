// pages/news.tsx
// ── Capital Coin Trade — News & Market Commentary page (Binance/Bybit standard) ──
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Crypto news, market commentary, and on-chain insights from Capital Coin Trade." />
      </Head>
