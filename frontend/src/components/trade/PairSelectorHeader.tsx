...
// ── PAIR HEADER (UPDATED WITH WS PRICE) ──
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col gap-1 sm:items-end">
          <div className="flex items-baseline gap-2">
            <span
              ref={priceRef}
              className={`tabular text-2xl sm:text-3xl font-bold text-[var(--text-primary)] ${
                flash === 'up' ? 'flash-up' : ''
            ...
            {change24h !== null && (
              <span
                className={`tabular text-sm font-semibold inline-flex items-center gap-1 ${
